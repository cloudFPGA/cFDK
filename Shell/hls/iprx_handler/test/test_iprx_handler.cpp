...
int main(int argc, char* argv[]) {
	...
	while (count < 30000)	{
		...
		//ip_handler_1(inFIFO, outFifoARP, outFifoICMP, outFifoICMPexp, outFifoUDP, outFifoTCP, ipAddress, 0x60504030201);
		ip_handler_2(inFIFO, outFifoARP, outFifoICMP, outFifoICMPexp, outFifoUDP, outFifoTCP, ipAddress, 0x60504030201);
		count++;
	}
