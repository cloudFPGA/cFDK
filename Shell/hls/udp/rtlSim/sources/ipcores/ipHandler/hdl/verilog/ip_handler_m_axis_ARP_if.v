...
module ip_handler_m_axis_ARP_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
ip_handler_m_axis_ARP_reg_slice #(
    .N       ( 73 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
module ip_handler_m_axis_ARP_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module ip_handler_m_axis_ARP_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
