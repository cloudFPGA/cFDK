...
//OBSOLETE-20180126 #include "mac_ip_encode.hpp"
 ...
 */
//OBSOLETE-20180126 void mac_ip_encode(
void iptx_handler (
...
#pragma HLS INTERFACE ap_ctrl_none port=return
	...
	//#pragma HLS INTERFACE 	port=dataOut 				ap_fifo
	//#pragma HLS INTERFACE 	port=arpTableIn 			ap_fifo
	//#pragma HLS INTERFACE 	port=arpTableOut 			ap_fifo
...
#pragma HLS resource core=AXI4Stream variable=arpTableIn metadata="-bus_bundle s_arpTableIn"
#pragma HLS resource core=AXI4Stream variable=arpTableOut metadata="-bus_bundle m_arpTableOut"
