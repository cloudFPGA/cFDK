 ...
 *
 * @note       : This block is not used in a cloudFPGA system and it is
 *                therefore disabled.
 * @remark     : { remark text }
 * @warning    :
 * @todo       : [TODO - Remove this block from NTS]
 *
...
void pFsmCtrl(
		...
		ap_uint<32>			&poNts_IpAddress) //OBSOLETE-20180828 ap_uint<32> &inputIpAddress)

{
    ...
    case PORT_WAIT:
    	//OBSOLETE-20180828 myIpAddress = inputIpAddress;
 ...
 * //OBSOLETE-20180828 @param[in]  piMMIO_This_IpAddress  IPv4 address from MMIO.
...
void dhcp_client(
		...
		//------------------------------------------------------
		//OBSOLETE-20180828 ap_uint<32>            &piMMIO_This_IpAddress,
		...
		stream<UdpPort>		&soTHIS_Udmx_PLen)
{
	...
	#pragma HLS INTERFACE ap_stable port=piMMIO_This_Enable	    //OBSOLETE-20180827 #pragma HLS INTERFACE ap_none register	port=dhcpEnable
	#pragma HLS INTERFACE ap_stable port=piMMIO_This_MacAddress //OBSOLETE-20180827 #pragma HLS INTERFACE ap_stable			port=myMacAddress

	//OBSOLETE-20180827 #pragma HLS INTERFACE ap_none register	port=inputIpAddress
	#pragma HLS INTERFACE ap_none register port=poTHIS_Nts_IpAddress    //OBSOLETE 	#pragma HLS INTERFACE ap_none register	port=dhcpIpAddressOut

	#pragma HLS INTERFACE axis register forward port=siUDMX_This_OpnAck  //OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=confirmPortStatus metadata="-bus_bundle s_axis_open_port_status"
	#pragma HLS INTERFACE axis register forward port=soTHIS_Udmx_OpnReq  //OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=openPort 		    metadata="-bus_bundle m_axis_open_port"

	#pragma HLS INTERFACE axis register forward port=siUDMX_This_Data 	//OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=dataIn 			metadata="-bus_bundle s_axis_rx_data"
	#pragma HLS INTERFACE axis register forward port=siUDMX_This_Meta 	//OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=dataInMeta 		metadata="-bus_bundle s_axis_rx_metadata"
	#pragma HLS DATA_PACK                   variable=siUDMX_This_Meta instance=siUDMX_This_Meta //OBSOLETE-20180827 #pragma HLS DATA_PACK variable=dataInMeta

	#pragma HLS INTERFACE axis register forward port=soTHIS_Udmx_Data 	//OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=dataOut 			metadata="-bus_bundle m_axis_tx_data"
	#pragma HLS INTERFACE axis register forward port=soTHIS_Udmx_Meta 	//OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=dataOutMeta 		metadata="-bus_bundle m_axis_tx_metadata"
	#pragma HLS DATA_PACK                   variable=soTHIS_Udmx_Meta instance=soTHIS_Udmx_Meta //OBSOLETE-20180827 #pragma HLS DATA_PACK variable=dataOutMeta
	#pragma HLS INTERFACE axis register forward port=soTHIS_Udmx_PLen	//OBSOLETE-20180827 #pragma HLS resource core=AXI4Stream variable=dataOutLength 	metadata="-bus_bundle m_axis_tx_length"
