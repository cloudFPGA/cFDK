...
create_ip -name pr_decoupler -vendor xilinx.com -library ip -version 1.0 -module_name Decoupler

# Role_x1Udp_x1Tcp_x2Mp 

set_property -dict [list CONFIG.ALL_PARAMS {HAS_AXI_LITE 0 HAS_AXIS_CONTROL 0 INTF { ROLE {ID 0 SIGNALS { \
...
generate_target all [get_ips Decoupler]


create_ip_run [get_ips Decoupler]

#launch_runs -jobs 8 Decoupler_synth_1
