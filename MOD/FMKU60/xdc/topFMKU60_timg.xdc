...
#   pin or net.
#===============================================================================
#OBSOLETE-20210322 create_clock -period 1000.000 -name topResetUsedAsClk [get_pins TOP_META_RST/DOUT]
...
#OBSOLETE_20210322 set_clock_groups -asynchronous -group [get_clocks piPSOC_Emif_Clk] -group [get_clocks -of_objects [get_pins SHELL/SuperCfg.ETH0/ETH/CORE/IP/U0/xpcs/U0/ten_gig_eth_pcs_pma_shared_clock_reset_block/txusrclk2_bufg_gt_i/O]]
#OBSOLETE_20210322 set_clock_groups -asynchronous -group [get_clocks piPSOC_Emif_Clk] -group [get_clocks -of_objects [get_pins SHELL/SuperCfg.ETH0/ETH/CORE/IP/U0/xpcs/inst/ten_gig_eth_pcs_pma_shared_clock_reset_block/txusrclk2_bufg_gt_i/O]]
...
# Asynchronous Clocks Between CLKT/10GE/Clk and SHELL/CLK
set_clock_groups -asynchronous -group [get_clocks piCLKT_10GeClk_p] -group [get_clocks piPSOC_Emif_Clk]
# [TODO] set_clock_groups -asynchronous -group [get_clocks piCLKT_10GeClk_p] -group ${myShellClk}
...
#OBSOLETE_20210322 set_clock_groups -asynchronous -group [get_clocks topResetUsedAsClk] -group [get_clocks piPSOC_Emif_Clk]
#OBSOLETE_2021032  set_clock_groups -asynchronous -group [get_clocks -of_objects [get_pins SHELL/SuperCfg.ETH0/ETH/CORE/IP/U0/xpcs/U0/ten_gig_eth_pcs_pma_shared_clock_reset_block/txusrclk2_bufg_gt_i/O]] -group [get_clocks topResetUsedAsClk]
...
#=====================================================================
#OBSOLETE_20210323 set_false_path -from [get_pins SHELL/sLed_HeartBeat_reg_inv/C] -to [get_ports poLED_HeartBeat_n]
