...
reg   [3:0] storemerge6_phi_fu_390_p4;
...
wire   [3:0] storemerge7_fu_997_p3;
...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_const_lv1_0 == grp_nbreadreq_fu_304_p5) & ~(ap_const_lv1_0 == grp_nbwritereq_fu_364_p5) & (ap_const_lv4_0 == stripState) & ~ap_sig_bdd_237)) begin
        ...
        stripState <= storemerge6_phi_fu_390_p4;
        ...
        stripState <= storemerge7_fu_997_p3;
...
/// storemerge6_phi_fu_390_p4 assign process. ///
always @ (grp_fu_435_p1 or ap_sig_bdd_410)
begin
    if (ap_sig_bdd_410) begin
        if ((ap_const_lv1_0 == grp_fu_435_p1)) begin
            storemerge6_phi_fu_390_p4 = ap_const_lv4_6;
        end else if (~(ap_const_lv1_0 == grp_fu_435_p1)) begin
            storemerge6_phi_fu_390_p4 = ap_const_lv4_8;
        end else begin
            storemerge6_phi_fu_390_p4 = 'bx;
        end
    end else begin
        storemerge6_phi_fu_390_p4 = 'bx;
    end
...
assign storemerge7_fu_997_p3 = ((grp_fu_525_p2[0:0]===1'b1)? ap_const_lv4_0: ap_const_lv4_A);
