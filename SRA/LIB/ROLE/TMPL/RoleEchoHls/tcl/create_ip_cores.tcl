...
# *   the current ROLE. These IP cores can be created from the Vivado repository
# *   of the Xilinx-IP catalog or from the ../hls directory of User-IP catalog.
# * 
...
# Set the Global Settings used by the ROLE Project
#-------------------------------------------------------------------------------
...
my_puts "################################################################################"
my_puts "##"
my_puts "##  CREATING IP CORES FOR THE ROLE "
my_puts "##"
my_puts "################################################################################"
...
#------------------------------------------------------------------------------  
# VIVADO-IP : AXI Register Slice (provided here as an example)
#------------------------------------------------------------------------------
#  Signal Properties
#    [Yes] : Enable TREADY
#    [8]   : TDATA Width (bytes)
