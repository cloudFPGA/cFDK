...
if { $hlsCSim} {
    ...
    csim_design -argv "../../../../test/testVectors/siTOE_OnePkt.dat"
    csim_design -argv "../../../../test/testVectors/siTOE_ThreePkt.dat"
    csim_design -argv "../../../../test/testVectors/siTOE_TwentySixPkt.dat"
    csim_design -argv "../../../../test/testVectors/siL3_WrongSubNet.dat"
    csim_design -argv "../../../../test/testVectors/siUOE_RampDgrmSize.dat"   
    csim_design -argv "../../../../test/testVectors/siL3_IpOptions.dat"   
    puts "#############################################################"
    puts "####                                                     ####"
...
#-------------------------------------------------
if { $hlsCoSim } {
    cosim_design -tool xsim -rtl verilog -trace_level none -argv "../../../../test/testVectors/siTOE_OnePkt.dat"
    cosim_design -tool xsim -rtl verilog -trace_level none -argv "../../../../test/testVectors/siTOE_ThreePkt.dat"
    cosim_design -tool xsim -rtl verilog -trace_level none -argv "../../../../test/testVectors/siTOE_TwentySixPkt.dat"
    cosim_design -tool xsim -rtl verilog -trace_level none -argv "../../../../test/testVectors/siL3_WrongSubNet.dat"
    cosim_design -tool xsim -rtl verilog -trace_level none -argv "../../../../test/testVectors/siUOE_RampDgrmSize.dat"
    cosim_design -tool xsim -rtl verilog -trace_level none -argv "../../../../test/testVectors/siL3_IpOptions.dat"
    puts "#############################################################"
    puts "####                                                     ####"
