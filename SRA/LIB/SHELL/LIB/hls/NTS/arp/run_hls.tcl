...
set ipDisplayName  "ARP Server for cloudFPGA"
set ipDescription  "Address mapping from L3-IP to a L2-MAC."
set ipVendor       "IBM"
set ipLibrary      "hls"
set ipVersion      "1.0"
...
#------------------------------------------------------------------------------------------------
config_compile -name_max_lengths 256 -pipeline_loops 0
