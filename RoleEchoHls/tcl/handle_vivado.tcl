...
if { ${create} } {
    ...
    set_property "target_language" "Verilog"            ${xprObj}           -verbose
    ...
    my_dbg_trace "Setting ip_repo_paths to ${ipDir} ${hlsDir}" ${dbgLvl_1}
    set_property "ip_repo_paths" "${ipDir} ${hlsDir}" ${srcObj}
