...
#-------------------------------------------------------------------------------
set xprName      "roleEchoStoreAndForward" 
...
# Note used: set ipSraDir     ${rootDir}/../../IP
# Note used: set ipSraXprName "managed_ip_project"
# Note used: set ipSraXprDir  ${ipSraDir}/${ipSraXprName}
# Note used: set ipSraXprFile [ file join ${ipSraXprDir} ${ipSraXprName}.xpr ]
